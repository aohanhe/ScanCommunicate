 ...
 *
 */
@DownCommand(name = "中断充电下行", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.STOP_COMMAND)
public class Is1StopCommand extends Is1BaseDownPacket {
	...
	public Is1StopCommand() {
		this.setCmd((byte) Is1GlobalConst.STOP_COMMAND);
	}

	public Is1StopCommand(int addr) {
		this.setCmd((byte) Is1GlobalConst.STOP_COMMAND);
