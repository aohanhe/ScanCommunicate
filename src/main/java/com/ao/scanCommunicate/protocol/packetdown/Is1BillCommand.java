 ...
 *
 */
@DownCommand(name = "获取账单下行", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.BILL_COMMAND)
public class Is1BillCommand extends Is1BaseDownPacket {
	/**
	 * 单头地址，指示单头位置
	 * 
	 * @return
	...
	public Is1BillCommand() {
		this.setCmd((byte) Is1GlobalConst.BILL_COMMAND);
	}

	public Is1BillCommand(int addr) {
		this.setCmd((byte) Is1GlobalConst.BILL_COMMAND);
