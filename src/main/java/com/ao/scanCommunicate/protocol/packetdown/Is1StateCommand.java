 ...
 *
 */
@DownCommand(name = "获取设备状态下行", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.STATE_COMMAND)
public class Is1StateCommand extends Is1BaseDownPacket {
	/**
	 * 单头地址，指示单头位置
	 * 
	 * @return
	...
	public Is1StateCommand() {
		this.setCmd((byte) Is1GlobalConst.STATE_COMMAND);
	}

	public Is1StateCommand(int addr) {
		this.setCmd((byte) Is1GlobalConst.STATE_COMMAND);
