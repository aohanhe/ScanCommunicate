 ...
 *
 */
@DownCommand(name = "设备回应状态下行指令包", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.STATE_RESPONSE_COMMAND)
public class Is1StateResponseCommand extends Is1BaseDownPacket {
	...
	public Is1StateResponseCommand() {
		this.setCmd((byte) Is1GlobalConst.STATE_RESPONSE_COMMAND);
	}

	public Is1StateResponseCommand(int addr) {
		this.setCmd((byte) Is1GlobalConst.STATE_RESPONSE_COMMAND);
