 ...
 *
 */
@UpCommand(name = "成功反馈上行", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.SUCCESS_RESPONSE)
public interface Is1SuccessResponse extends BaseCommand, Is1UpHeader {
	/**
	 * 单头地址，指示单头位置
	 * 
	 * @return
