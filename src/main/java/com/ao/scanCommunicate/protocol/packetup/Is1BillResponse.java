 ...
 *
 */
@UpCommand(name = "获取账单上行", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.BILL_RESPONSE)
public interface Is1BillResponse extends BaseCommand, Is1UpHeader {
	/**
	 * 单头地址，指示单头位置
	 * 
	 * @return
