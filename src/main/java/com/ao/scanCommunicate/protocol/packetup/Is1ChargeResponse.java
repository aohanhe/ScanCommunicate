 ...
 *
 */
@UpCommand(name = "开始充电上行", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.CHARGE_RESPONSE)
public interface Is1ChargeResponse extends BaseCommand, Is1UpHeader {
	/**
	 * 单头地址，指示单头位置
	 * 
	 * @return
