 ...
 *
 */
@UpCommand(name = "恢复充电上行", protocolId = Is1GlobalConst.IS1_PROTOCOL, value = Is1GlobalConst.RESUME_RESPONSE)
public interface Is1ResumeResponse extends BaseCommand, Is1UpHeader {
	/**
	 * 单头地址，指示单头位置
	 * 
	 * @return
